...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        defaultOTPDrawable = ResourcesCompat.getColor(context.resources, android.R.color.transparent, null)
        ...
        val boxBackgroundColor = styles.getResourceId(R.styleable.OtpTextView_otp_box_background, ResourcesCompat.getColor(context.resources, android.R.color.transparent, null))
